...
class PettyCashController extends Controller
{
    ...
    public function bulkSubmitHardfile(Request $request)
    {
        ...
        foreach ($validated['document_ids'] as $docId) {
            try {
                ...
                $this->notificationService->notifyHardfileSubmitted($pettyCash, Auth::user());
                $successCount++;
            } catch (\Exception $e) {
     ...
     */
    public function submitHardfile(Request $request, PettyCash $pettyCash)
    {
        ...
        try {
            ...
            return redirect()->route('user.petty-cash.show', $pettyCash)
