...
class CashAdvanceDrawController extends Controller
{
    ...
    public function approve(Request $request, CashAdvanceDraw $cashAdvanceDraw)
    {
        ...
        try {
            ...
            $this->notificationService->notifyDocumentApproved($cashAdvanceDraw, Auth::user(), 'Accounting Manager', $validated['remark'] ?? null, 2);
    ...
    public function reject(Request $request, CashAdvanceDraw $cashAdvanceDraw)
    {
        ...
        try {
            ...
            $this->notificationService->notifyDocumentRejected($cashAdvanceDraw, Auth::user(), 'Accounting Manager', $validated['remark'], 2);
