...
class UpdatePettyCashRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pcr_form' => 'sometimes|file|mimes:pdf,xlsx,xls,jpg,jpeg,png|max:5120',
            'document_number' => 'required|string|max:255|unique:petty_cash,document_number,' . $this->route('pettyCash')->id,
            'original_invoice' => 'sometimes|file|mimes:pdf,xlsx,xls,jpg,jpeg,png|max:5120',
            'copy_invoice' => 'sometimes|file|mimes:pdf,xlsx,xls,jpg,jpeg,png|max:5120',
