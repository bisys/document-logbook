...
<section class="section">
    <div class="section-header">
        <h1>Cash Advance Draw - Approval Queue</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-receive-form" action="{{ route('accounting-staff.cash-advance-draw.bulk-receive-hardfile') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            @endphp
                                            @if(!$cashAdvanceDraw->hardfile_received_at && $hasStaffApproved)
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-staff.cash-advance-draw.show', $cashAdvanceDraw) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
