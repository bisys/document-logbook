@extends('layouts.app')
@section('title', 'Cash Advance Draw Review - Staff')
@section('content')
<section class="section">
    <div class="section-header">
        <div class="section-header-back"><a href="{{ route('accounting-staff.cash-advance-draw.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a></div>
        <h1>Cash Advance Draw Review - Staff</h1>
    </div>
                        ...
                        <div class="alert alert-success mb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-muted" style="color: white !important;">Received by: <strong>{{ optional($cashAdvanceDraw->hardfileReceivedByUser)->name ?? '-' }}</strong></span><br>
                                    <span class="text-muted" style="color: white !important;">Date: <strong>{{ $cashAdvanceDraw->hardfile_received_at->format('d M Y H:i') }}</strong></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mt-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @elseif($cashAdvanceDraw->hardfile_received_at && $isFullyApproved)
            ...
            <div class="col-md-6"><div class="card"><div class="card-header"><h4><i class="fas fa-check-circle mr-2"></i>Approval Chain</h4></div><div class="card-body"><div class="timeline">
                ...
                @empty<p class="text-muted">No approval chain available.</p>@endforelse
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('accounting-staff.cash-advance-draw.index') }}" class="btn btn-light">Back</a>
                        </div></div></div>
    </div></div></div></div></div>
</section>
<div class="modal fade" id="addRevisionModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.cash-advance-draw.add-revision', $cashAdvanceDraw) }}" method="POST" id="form-revision">@csrf
...
<div class="modal fade" id="approveModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.cash-advance-draw.approve', $cashAdvanceDraw) }}" method="POST">@csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.cash-advance-draw.reject', $cashAdvanceDraw) }}" method="POST">@csrf
...
<div class="modal fade" id="receiveHardfileModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.cash-advance-draw.receive-hardfile', $cashAdvanceDraw) }}" method="POST">@csrf
...
<div class="modal fade" id="processPaymentModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.cash-advance-draw.process-payment', $cashAdvanceDraw) }}" method="POST" enctype="multipart/form-data">@csrf
