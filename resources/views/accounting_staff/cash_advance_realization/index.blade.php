...
@section('title', 'Cash Advance Realization')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Cash Advance Realization - Approval Queue</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-receive-form" action="{{ route('accounting-staff.cash-advance-realization.bulk-receive-hardfile') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            @endphp
                                            @if(!$cashAdvanceRealization->hardfile_received_at && $hasStaffApproved)
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $cashAdvanceRealization->revisions()->count() }} revisions</span>
                                        </td>
                                        <td>
                                            @php
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-staff.cash-advance-realization.show', $cashAdvanceRealization) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
