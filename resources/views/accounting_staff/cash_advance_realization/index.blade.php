@extends('layouts.app')
@section('title', 'Cash Advance Realization - Staff Review')
@section('content')
<section class="section">
    <div class="section-header">
        <h1>Cash Advance Realization - Staff Review</h1>
                ...
                <div class="table-responsive"><table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('accounting-staff.cash-advance-realization.show', $cashAdvanceRealization) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                        </tr>
                        @empty
