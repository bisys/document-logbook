                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-staff.cash-advance-realization.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($cashAdvanceRealization->status)->slug === 'waiting-approval-staff')
                                            <div class="custom-checkbox custom-control">
