...
<section class="section">
    <div class="section-header">
        <h1>Supplier Payments - Approval Queue</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-receive-form" action="{{ route('accounting-staff.supplier-payment.bulk-receive-hardfile') }}" method="POST">
                                @csrf
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @php
                                                ...
                                                $hasStaffApproved = $staffRole ? $payment->approvals->where('approval_role_id', $staffRole->id)->where('approval_status_id', 1)->isNotEmpty() : false;
                                            @endphp
                                            @if(!$payment->hardfile_received_at && $hasStaffApproved)
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input doc-checkbox" id="checkbox-{{ $payment->id }}" value="{{ $payment->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-staff.supplier-payment.show', $payment) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
