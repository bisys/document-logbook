                                        ...
                                        <div class="alert alert-success mb-0">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-muted" style="color: white !important;">Received by: <strong>{{ optional($supplierPayment->hardfileReceivedByUser)->name ?? '-' }}</strong></span><br>
                                                    <span class="text-muted" style="color: white !important;">Date: <strong>{{ $supplierPayment->hardfile_received_at->format('d M Y H:i') }}</strong></span>
                                                </div>
                                            </div>
                                        </div>
