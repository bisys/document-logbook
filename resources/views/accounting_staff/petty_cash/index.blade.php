...
<section class="section">
    <div class="section-header">
        <h1>Petty Cash - Approval Queue</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-receive-form" action="{{ route('accounting-staff.petty-cash.bulk-receive-hardfile') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            @endphp
                                            @if(!$pettyCash->hardfile_received_at && $hasStaffApproved)
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-staff.petty-cash.show', $pettyCash) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
