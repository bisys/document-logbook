@extends('layouts.app')
@section('title', 'Petty Cash - Staff Review')
@section('content')
<section class="section">
    <div class="section-header">
        <h1>Petty Cash - Staff Review</h1>
                ...
                <div class="table-responsive"><table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('accounting-staff.petty-cash.show', $pettyCash) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                        </tr>
                        @empty
