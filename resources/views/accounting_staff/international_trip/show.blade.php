@extends('layouts.app')
@section('title', 'International Trip Review - Staff')
@section('content')
<section class="section">
    <div class="section-header">
        <div class="section-header-back"><a href="{{ route('accounting-staff.international-trip.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a></div>
        <h1>International Trip Review - Staff</h1>
    </div>
    <div class="section-body"><div class="row"><div class="col-12"><div class="card"><div class="card-body">
        ...
        <div class="row mb-4"><div class="col-12"><ul class="list-group">
            @php $files=['itar_form'=>'ITAR Form','internal_memo'=>'Internal Memo','summary_bussiness_trip'=>'Summary Business Trip','overseas_allowance_form'=>'Overseas Allowance Form','bussiness_trip_allowance'=>'Business Trip Allowance','rate'=>'Rate','budget_plan'=>'Budget Plan','other_document'=>'Other Document']; @endphp
            ...
            <div class="col-md-6"><div class="card"><div class="card-header"><h4><i class="fas fa-check-circle mr-2"></i>Approval Chain</h4></div><div class="card-body"><div class="timeline">
                ...
                @empty<p class="text-muted">No approval chain available.</p>@endforelse
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('accounting-staff.international-trip.index') }}" class="btn btn-light">Back</a>
                        </div></div></div>
    </div></div></div></div></div>
</section>
<div class="modal fade" id="addRevisionModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.international-trip.add-revision', $internationalTrip) }}" method="POST" id="form-revision">@csrf
...
<div class="modal fade" id="approveModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.international-trip.approve', $internationalTrip) }}" method="POST">@csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-staff.international-trip.reject', $internationalTrip) }}" method="POST">@csrf
