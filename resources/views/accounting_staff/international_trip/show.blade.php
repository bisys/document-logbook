                        ...
                        <div class="alert alert-success mb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-muted" style="color: white !important;">Received by: <strong>{{ optional($internationalTrip->hardfileReceivedByUser)->name ?? '-' }}</strong></span><br>
                                    <span class="text-muted" style="color: white !important;">Date: <strong>{{ $internationalTrip->hardfile_received_at->format('d M Y H:i') }}</strong></span>
                                </div>
                            </div>
                        </div>
