...
@section('title', 'Supplier Payments - Manager Review')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Supplier Payments - Manager Review</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-manager.supplier-payment.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($payment->status)->slug === 'waiting-approval-manager')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $staffApproval = $payment->approvals()->where('approval_role_id', 1)->first();
                                            @endphp
                                            @if($staffApproval)
                                            @php
