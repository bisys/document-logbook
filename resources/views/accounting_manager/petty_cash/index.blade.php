...
@section('title', 'Petty Cash - Manager Review')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Petty Cash - Manager Review</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-manager.petty-cash.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($pettyCash->status)->slug === 'waiting-approval-manager')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $staffApproval = $pettyCash->approvals()->where('approval_role_id', 1)->first();
                                            @endphp
                                            @if($staffApproval)
                                            @php
