@extends('layouts.app')
@section('title', 'International Trip - Manager Review')
@section('content')
<section class="section">
    <div class="section-header">
        <h1>International Trip - Manager Review</h1>
                ...
                <div class="table-responsive"><table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('accounting-manager.international-trip.show', $internationalTrip) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                        </tr>
                        @empty
