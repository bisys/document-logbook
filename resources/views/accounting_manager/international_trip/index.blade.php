                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-manager.international-trip.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($internationalTrip->status)->slug === 'waiting-approval-manager')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $staffApproval = $internationalTrip->approvals()->where('approval_role_id', 1)->first();
                                            @endphp
                                            @if($staffApproval)
                                            @php
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-manager.international-trip.show', $internationalTrip) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
