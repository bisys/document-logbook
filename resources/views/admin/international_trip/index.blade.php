...
@section('title', 'International Trip - Admin')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>International Trip - Admin</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
            <div class="breadcrumb-item">International Trip</div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>All International Trip</h4>
                        <div class="card-header-action">
                            <span class="badge badge-primary">{{ $internationalTrips->count() }} Total</span>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <th>Hardfile</th>
                                ...
                                <tbody>
                                    @forelse($internationalTrips as $internationalTrip)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $internationalTrip->revisions()->count() }}</span>
                                        </td>
                                        <td>
                                            @php
                                            $approvalCount = $internationalTrip->approvals()->count();
                                            $approvedCount = $internationalTrip->approvals()->where('approval_status_id', 3)->count();
                                            @endphp
                                            <small>{{ $approvedCount }}/3</small>
                                        </td>
                                        <td>
                                            {{ optional($internationalTrip->created_at)->format('d M Y H:i') }}
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.international-trip.show', $internationalTrip) }}" class="btn btn-sm btn-primary">View</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-muted">No international trip found</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
