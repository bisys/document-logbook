...
@section('title', 'Cash Advance Realization Details - Admin')

@section('content')
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="{{ route('admin.cash-advance-realization.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Cash Advance Realization Details - Admin</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="{{ route('admin.cash-advance-realization.index') }}">Cash Advance Realization</a></div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <p class="mb-0 text-muted">Document Number: <strong>{{ $cashAdvanceRealization->document_number }}</strong></p>
                                <p class="mb-0 text-muted">Cost Center: <strong>{{ optional($cashAdvanceRealization->costCenter)->number }} - {{ optional($cashAdvanceRealization->costCenter)->name }}</strong></p>
                            </div>
                            <div>
                                @php
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @if($cashAdvanceRealization->revisions()->count() === 0)
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        $approvals = $cashAdvanceRealization->approvals()->with(['user','status','role'])->get();
                                        @endphp
                        ...
                        <div class="mt-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('admin.cash-advance-realization.index') }}" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="updateStatusModal" tabindex="-1" role="dialog" aria-labelledby="updateStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.cash-advance-realization.update-status', $cashAdvanceRealization) }}" method="POST">
                @csrf
