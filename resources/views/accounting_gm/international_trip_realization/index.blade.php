...
@section('title', 'International Trip Realization - GM Review')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>International Trip Realization - GM Review</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-gm.international-trip-realization.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($internationalTripRealization->status)->slug === 'waiting-approval-gm')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $managerApproval = $internationalTripRealization->approvals()->where('approval_role_id', 2)->first();
                                            @endphp
                                            @if($managerApproval)
                                            @php $statusText = $managerApproval->status->status; @endphp
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-gm.international-trip-realization.show', $internationalTripRealization) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
