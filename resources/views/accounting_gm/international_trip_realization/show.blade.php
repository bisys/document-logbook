@extends('layouts.app')
@section('title', 'International Trip Realization Review - GM')
@section('content')
<section class="section">
    <div class="section-header">
        <div class="section-header-back"><a href="{{ route('accounting-gm.international-trip-realization.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a></div>
        <h1>International Trip Realization Review - GM</h1>
    </div>
            ...
            <div class="col-md-6"><div class="card"><div class="card-header"><h4><i class="fas fa-check-circle mr-2"></i>Approval Chain</h4></div><div class="card-body"><div class="timeline">
                ...
                @empty<p class="text-muted">No approval chain available.</p>@endforelse
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('accounting-gm.international-trip-realization.index') }}" class="btn btn-light">Back</a>
                        </div></div></div>
    </div></div></div></div></div>
</section>
...
<div class="modal fade" id="approveModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-gm.international-trip-realization.approve', $internationalTripRealization) }}" method="POST">@csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <form action="{{ route('accounting-gm.international-trip-realization.reject', $internationalTripRealization) }}" method="POST">@csrf
