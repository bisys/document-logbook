...
@section('title', 'Petty Cash - GM Review')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Petty Cash - GM Review</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-gm.petty-cash.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($pettyCash->status)->slug === 'waiting-approval-gm')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $managerApproval = $pettyCash->approvals()->where('approval_role_id', 2)->first();
                                            @endphp
                                            @if($managerApproval)
                                            @php
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-gm.petty-cash.show', $pettyCash) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
