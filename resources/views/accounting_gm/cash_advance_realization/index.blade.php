...
@section('title', 'Cash Advance Realization - GM Review')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Cash Advance Realization - GM Review</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-gm.cash-advance-realization.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($cashAdvanceRealization->status)->slug === 'waiting-approval-gm')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $managerApproval = $cashAdvanceRealization->approvals()->where('approval_role_id', 2)->first();
                                            @endphp
                                            @if($managerApproval)
                                            @php
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-gm.cash-advance-realization.show', $cashAdvanceRealization) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
