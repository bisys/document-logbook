...
@section('title', 'Cash Advance Draw - GM Review')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Cash Advance Draw - GM Review</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-gm.cash-advance-draw.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($cashAdvanceDraw->status)->slug === 'waiting-approval-gm')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $managerApproval = $cashAdvanceDraw->approvals()->where('approval_role_id', 2)->first();
                                            @endphp
                                            @if($managerApproval)
                                            @php
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-gm.cash-advance-draw.show', $cashAdvanceDraw) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
