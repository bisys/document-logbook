@extends('layouts.app')
@section('title', 'International Trip - GM Review')
@section('content')
<section class="section">
    <div class="section-header">
        <h1>International Trip - GM Review</h1>
                ...
                <div class="table-responsive"><table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('accounting-gm.international-trip.show', $internationalTrip) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                        </tr>
                        @empty
