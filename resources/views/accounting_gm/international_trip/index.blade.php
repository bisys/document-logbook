                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form id="bulk-approve-form" action="{{ route('accounting-gm.international-trip.bulk-approve') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            @if(optional($internationalTrip->status)->slug === 'waiting-approval-gm')
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            @php
                                            $managerApproval = $internationalTrip->approvals()->where('approval_role_id', 2)->first();
                                            @endphp
                                            @if($managerApproval)
                                            @php
                                        ...
                                        <td>
                                            <a href="{{ route('accounting-gm.international-trip.show', $internationalTrip) }}" class="btn btn-sm btn-primary">Review</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
