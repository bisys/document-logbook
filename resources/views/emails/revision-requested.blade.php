...
<head>
    ...
    <title>Document Revision Requested</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 30px 40px; text-align: center;">
                            <h1 style="color: #000000ff; margin: 0; font-size: 22px; font-weight: 600;">🔄 Document Revision Requested</h1>
                        </td>
                    </tr>
                    <!-- Body -->
                    <tr>
                        <td style="padding: 30px 40px;">
                            ...
                            <p style="color: #4a5568; font-size: 15px; line-height: 1.6; margin: 0 0 20px;">
                                Your document requires a revision. Please check the revision notes below and make the necessary updates.
                            </p>

                            <!-- Document Info Card -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fffaf0; border-radius: 6px; border-left: 4px solid #dd6b20; margin: 20px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <table width="100%" cellpadding="4" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="color: #718096; font-size: 13px; vertical-align: top;">Purpose</td>
                                                <td style="color: #2d3748; font-size: 13px; font-weight: 600;">{{ $document->purpose ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td style="color: #718096; font-size: 13px; vertical-align: top;">Revision Count</td>
                                                <td style="color: #2d3748; font-size: 13px; font-weight: 600;">{{ $revision->revision_times }}</td>
                                            </tr>
                                            <tr>
                                                <td style="color: #718096; font-size: 13px; vertical-align: top;">Requested By</td>
                                                <td style="color: #2d3748; font-size: 13px; font-weight: 600;">{{ $requester->name ?? 'Accounting Staff' }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fff5f5; border-radius: 6px; margin: 20px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="color: #c53030; font-size: 13px; font-weight: 600; margin: 0 0 8px;">📝 Revision Note:</p>
                                        <p style="color: #4a5568; font-size: 14px; line-height: 1.6; margin: 0;">{{ $revision->remark }}</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="color: #4a5568; font-size: 15px; line-height: 1.6; margin: 20px 0;">
                                Please login to the system to revise your document.
                            </p>
