...
<head>
    ...
    <title>Hardfile Submitted</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 30px 40px; text-align: center;">
                            <h1 style="color: #000000ff; margin: 0; font-size: 22px; font-weight: 600;">📦 Hardfile Submitted</h1>
                        </td>
                    </tr>
                    <!-- Body -->
                    <tr>
                        <td style="padding: 30px 40px;">
                            <p style="color: #4a5568; font-size: 15px; line-height: 1.6; margin: 0 0 20px;">
                                A document hardfile has been <strong style="color: #d69e2e;">submitted</strong> by the user. Below are the details:
                            </p>

                            <!-- Document Info Card -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fffff0; border-radius: 6px; border-left: 4px solid #d69e2e; margin: 20px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <table width="100%" cellpadding="4" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="color: #718096; font-size: 13px; vertical-align: top;">Submit Date</td>
                                                <td style="color: #2d3748; font-size: 13px; font-weight: 600;">{{ $document->hardfile_submitted_at ? $document->hardfile_submitted_at->format('M d, Y, H:i') : now()->format('M d, Y, H:i') }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <p style="color: #4a5568; font-size: 15px; line-height: 1.6; margin: 20px 0;">
                                Please login to the system to receive the document hardfile.
                            </p>
