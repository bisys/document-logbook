...
<head>
    ...
    <title>Payment Processed Notifications</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 30px 40px; text-align: center;">
                            <h1 style="color: #000000ff; margin: 0; font-size: 22px; font-weight: 600;">✅ Payment Processed</h1>
                        </td>
                    </tr>
                    <!-- Body -->
                    <tr>
                        <td style="padding: 30px 40px;">
                            <p style="color: #4a5568; font-size: 15px; line-height: 1.6; margin: 0 0 20px;">
                                The following document has been <strong style="color: #276749;">successfully processed</strong>.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        <table width="100%" cellpadding="4" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="color: #718096; font-size: 13px; vertical-align: top;">Processed By</td>
                                                <td style="color: #2d3748; font-size: 13px; font-weight: 600;">{{ optional($processor)->name }} (Accounting Staff)</td>
                                            </tr>
                                            <tr>
                                                <td style="color: #718096; font-size: 13px; vertical-align: top;">Processed Date</td>
                                                <td style="color: #2d3748; font-size: 13px; font-weight: 600;">{{ \Carbon\Carbon::parse($document->paid_at)->format('d M Y H:i') }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <p style="color: #4a5568; font-size: 15px; line-height: 1.6; margin: 20px 0;">
                                You can view the document and download the payment receipt by clicking the link below.
                            </p>
