    ...
    <div class="section-body"><div class="row"><div class="col-12"><div class="card"><div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6"><div class="card"><div class="card-header"><h4>Revisions</h4></div><div class="card-body">
                @if($pendingRevisions->isEmpty() && $cashAdvanceRealization->revisions()->count()===0)<p class="text-muted">No revisions.</p>
        ...
        <div class="mt-3">
            @if($canEdit)<a href="{{ route('user.cash-advance-realization.edit', $cashAdvanceRealization) }}" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>@endif
...
<div class="modal fade" id="revisionModal{{ $rev->id }}" tabindex="-1"><div class="modal-dialog modal-lg"><div class="modal-content">
    ...
    <form action="{{ route('user.cash-advance-realization.submit-revision', [$cashAdvanceRealization, $rev]) }}" method="POST" enctype="multipart/form-data">@csrf
        <div class="modal-body">
            <p class="text-muted">Upload replacement files as needed:</p>
            @foreach(['car_form'=>'CAR Form','original_invoice'=>'Original Invoice','copy_invoice'=>'Copy Invoice','internal_memo_entertain'=>'Internal Memo Entertain','entertain_realization_form'=>'Entertain Realization Form','minutes_of_meeting'=>'Minutes Of Meeting','nominative_summary'=>'Nominative Summary','cic_form'=>'CIC Form','budget_plan'=>'Budget Plan',] as $field=>$fileLabel)
