    ...
    <div class="section-body">
        <div class="row"><div class="col-12"><div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('user.cash-advance-realization.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Create New</a>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive"><table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('user.cash-advance-realization.show', $cashAdvanceRealization) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                        </tr>
                        @empty
