...
<section class="section">
    <div class="section-header">
        <h1>Cash Advance Realization</h1>
        <div class="section-header-button">
            <a href="{{ route('user.cash-advance-realization.create') }}" class="btn btn-primary">Create New</a>
        </div>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="#">Cash Advance Realization</a></div>
            <div class="breadcrumb-item">
                @if($statusFilter === 'all') All Cash Advance Realization @elseif($statusFilter === 'waiting-approval-staff') Waiting Approval Staff @elseif($statusFilter === 'waiting-approval-manager') Waiting Approval Manager @elseif($statusFilter === 'waiting-approval-gm') Waiting Approval GM @elseif($statusFilter === 'waiting-revision') Waiting Revision @elseif($statusFilter === 'fully-approved') Fully Approved @endif
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            @if($statusFilter === 'all') All Cash Advance Realization
