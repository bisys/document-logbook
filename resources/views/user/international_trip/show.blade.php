    ...
    <div class="section-body"><div class="row"><div class="col-12"><div class="card"><div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6"><div class="card"><div class="card-header"><h4>Revisions</h4></div><div class="card-body">
                @if($pendingRevisions->isEmpty() && $internationalTrip->revisions()->count()===0)<p class="text-muted">No revisions.</p>
        ...
        <div class="mt-3">
            @if($canEdit)<a href="{{ route('user.international-trip.edit', $internationalTrip) }}" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>@endif
...
<div class="modal fade" id="revisionModal{{ $rev->id }}" tabindex="-1"><div class="modal-dialog modal-lg"><div class="modal-content">
    ...
    <form action="{{ route('user.international-trip.submit-revision', [$internationalTrip, $rev]) }}" method="POST" enctype="multipart/form-data">@csrf
        <div class="modal-body">
            <p class="text-muted">Upload replacement files as needed:</p>
            @foreach(['itar_form'=>'ITAR Form','internal_memo'=>'Internal Memo','summary_bussiness_trip'=>'Summary Business Trip','overseas_allowance_form'=>'Overseas Allowance Form','bussiness_trip_allowance'=>'Business Trip Allowance','rate'=>'Rate','budget_plan'=>'Budget Plan',] as $field=>$fileLabel)
