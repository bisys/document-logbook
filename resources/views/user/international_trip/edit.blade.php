            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.international-trip.update', $internationalTrip->id) }}" method="POST" enctype="multipart/form-data" id="edit-form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="purpose" value="{{ old('purpose', $internationalTrip->purpose) }}" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
