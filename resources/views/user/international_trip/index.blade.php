            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            @if($statusFilter === 'all') All International Trip
                        ...
                        <div class="card-header-action">
                            <form id="bulk-submit-form" action="{{ route('user.international-trip.bulk-submit-hardfile') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            @endphp
                                            @if(!$internationalTrip->is_hardfile_submitted && $hasStaffApproved)
                                            <div class="custom-checkbox custom-control">
