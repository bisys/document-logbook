            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.cash-advance-draw.update', $cashAdvanceDraw->id) }}" method="POST" enctype="multipart/form-data" id="edit-form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Purpose*</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="purpose" value="{{ old('purpose', $cashAdvanceDraw->purpose) }}" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    @if(!empty($cashAdvanceDraw->other_document))
                                    <div class="card card-sm mb-2 bg-light">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <small class="text-muted">Current File:</small><br>
                                                    <strong>{{ basename($cashAdvanceDraw->other_document) }}</strong>
                                                </div>
                                                <a href="{{ asset('storage/' . $cashAdvanceDraw->other_document) }}" target="_blank" class="btn btn-sm btn-outline-primary">View</a>
                                            </div>
                                        </div>
                                    </div>
                                    <small class="text-muted">Upload a new file to replace it (optional)</small>
