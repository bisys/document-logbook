...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Create Cash Advance Draw</div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.cash-advance-draw.store') }}" method="POST" enctype="multipart/form-data" id="form">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div class="custom-file">
                                        <input type="file" name="proposal_or_monitor_budget" class="custom-file-input" id="proposal-or-monitor-budget" required>
                                        <label class="custom-file-label">Choose File</label>
                                    </div>
                                    <div class="form-text text-muted">The file must have a maximum size of 5MB</div>
                                </div>
