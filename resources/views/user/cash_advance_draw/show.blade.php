...
<div class="modal fade" id="revisionModal{{ $revision->id }}" tabindex="-1" role="dialog" aria-labelledby="revisionModalLabel{{ $revision->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('user.cash-advance-draw.submit-revision', [$cashAdvanceDraw, $revision]) }}" method="POST" enctype="multipart/form-data" id="revision-form">
                @csrf
...
@if(!$cashAdvanceDraw->is_hardfile_submitted && $staffApproved)
<div class="modal fade" id="submitHardfileModal" tabindex="-1" role="dialog" aria-labelledby="submitHardfileModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('user.cash-advance-draw.submit-hardfile', $cashAdvanceDraw) }}" method="POST" id="submit-hardfile-form">
                @csrf
                <div class="modal-body">
