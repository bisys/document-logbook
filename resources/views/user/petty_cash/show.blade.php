                                                ...
                                                <div class="alert alert-success mb-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="text-white">Date: <strong>{{ optional($pettyCash->hardfile_submitted_at)->format('d M Y H:i') }}</strong></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="alert alert-success mb-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="text-white">Received by: <strong>{{ optional($pettyCash->hardfileReceivedByUser)->name ?? '-' }}</strong></span><br>
                                                            <span class="text-white">Date: <strong>{{ optional($pettyCash->hardfile_received_at)->format('d M Y H:i') }}</strong></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            @elseif($pettyCash->is_hardfile_submitted)
...
<div class="modal fade" id="revisionModal{{ $revision->id }}" tabindex="-1" role="dialog" aria-labelledby="revisionModalLabel{{ $revision->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('user.petty-cash.submit-revision', [$pettyCash, $revision]) }}" method="POST" enctype="multipart/form-data" id="revision-form">
                @csrf
...
@if(!$pettyCash->is_hardfile_submitted && $staffApproved)
<div class="modal fade" id="submitHardfileModal" tabindex="-1" role="dialog" aria-labelledby="submitHardfileModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('user.petty-cash.submit-hardfile', $pettyCash) }}" method="POST" id="submit-hardfile-form">
                @csrf
                <div class="modal-body">
