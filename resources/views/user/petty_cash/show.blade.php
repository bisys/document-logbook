    ...
    <div class="section-body"><div class="row"><div class="col-12"><div class="card"><div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6"><div class="card"><div class="card-header"><h4>Revisions</h4></div><div class="card-body">
                @if($pendingRevisions->isEmpty() && $pettyCash->revisions()->count()===0)<p class="text-muted">No revisions.</p>
        ...
        <div class="mt-3">
            @if($canEdit)<a href="{{ route('user.petty-cash.edit', $pettyCash) }}" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>@endif
