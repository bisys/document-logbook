...
@if(!$supplierPayment->is_hardfile_submitted && $staffApproved)
<div class="modal fade" id="submitHardfileModal" tabindex="-1" role="dialog" aria-labelledby="submitHardfileModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('user.supplier-payment.submit-hardfile', $supplierPayment) }}" method="POST" id="submit-hardfile-form">
                @csrf
                <div class="modal-body">
