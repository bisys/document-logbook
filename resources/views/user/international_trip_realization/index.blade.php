...
<section class="section">
    <div class="section-header">
        <h1>International Trip Realization</h1>
        <div class="section-header-button">
            <a href="{{ route('user.international-trip-realization.create') }}" class="btn btn-primary">Create New</a>
        </div>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="#">International Trip Realization</a></div>
            <div class="breadcrumb-item">
                @if($statusFilter === 'all') All International Trip Realization @elseif($statusFilter === 'waiting-approval-staff') Waiting Approval Staff @elseif($statusFilter === 'waiting-approval-manager') Waiting Approval Manager @elseif($statusFilter === 'waiting-approval-gm') Waiting Approval GM @elseif($statusFilter === 'waiting-revision') Waiting Revision @elseif($statusFilter === 'fully-approved') Fully Approved @endif
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            @if($statusFilter === 'all') All International Trip Realization
                        ...
                        <div class="card-header-action">
                            <form id="bulk-submit-form" action="{{ route('user.international-trip-realization.bulk-submit-hardfile') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            @endphp
                                            @if(!$internationalTripRealization->is_hardfile_submitted && $hasStaffApproved)
                                            <div class="custom-checkbox custom-control">
                                        ...
                                        <td>
                                            <a href="{{ route('user.international-trip-realization.show', $internationalTripRealization) }}" class="btn btn-sm btn-primary">Detail</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
